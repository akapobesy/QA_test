...
FILE_TO_SEND1 = r"C:\files\Msteams.png"
...
def open_telegram(profile_path: str, profile_name: str = "Default", url: str = "https://go.microsoft.com/fwlink/?linkid=873020&clcid=0x419&culture=ru-ru&country=ru", timeout: int = 15):
...
def messeges_telegram():
    ...
    #search_field = pyautogui.locateCenterOnScreen('Screens/msteams_icon.png', confidence=0.8)
    #if search_field:
    ...
    message_field = pyautogui.locateCenterOnScreen('Screens/msteams_field.png', confidence=0.8)
    if message_field:
        pyautogui.click(message_field)
        time.sleep(1)
        message_sender = Messages("This is test messages_web_msteams")
...
def check_database():
    try:
        ...
        if db.message_exists(messages, 'This is test This is test messages_web_msteams'):
        ...
        if db.message_exists(files, 'Msteams_web.pdf'):
...
def main():
    ...
    try:
         #0. Логирование
        report = ReportFolder("C:/Reports/Web/Msteams")
