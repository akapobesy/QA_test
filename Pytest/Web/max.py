...
FILE_TO_SEND1 = r"C:\files\Slackweb.pdf"
...
def open_telegram(profile_path: str, profile_name: str = "Default", url: str = "https://app.slack.com/client/", timeout: int = 15):
...
def messeges_telegram():
    ...
    search_field = pyautogui.locateCenterOnScreen('Screens/slack_icon.png', confidence=0.8)
    if search_field:
    ...
    message_field = pyautogui.locateCenterOnScreen('Screens/slack_field.png', confidence=0.8)
    if message_field:
        pyautogui.click(message_field)
        time.sleep(1)
        message_sender = Messages("This is test messages_web_slack")
...
def check_database():
    try:
        ...
        if db.message_exists(messages, 'This is test This is test messages_web_slack'):
        ...
        if db.message_exists(files, 'Slackweb.pdf'):
...
def main():
    ...
    try:
         #0. Логирование
        report = ReportFolder("C:/Reports/Web/Slack")
