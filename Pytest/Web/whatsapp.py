...
FILE_TO_SEND1 = r"C:\files\Whatsapp_web.pdf"
...
def open_telegram(profile_path: str, profile_name: str = "Default", url: str = "https://web.whatsapp.com/", timeout: int = 15):
...
def messeges_telegram():
    ...
    if message_field:
        ...
        time.sleep(1)
        message_sender = Messages("This is test messages_web_whatsapp")
...
def check_database():
    try:
        ...
        if db.message_exists(messages, 'This is test This is test messages_web_whatsapp'):
        ...
        if db.message_exists(files, 'Whatsapp_web.pdf'):
...
def main():
    ...
    try:
         #0. Логирование
        report = ReportFolder("C:/Reports/Web/Whatsapp")
