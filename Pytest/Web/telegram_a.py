...
FILE_TO_SEND1 = r"C:\files\Telegramweba.pdf"
...
def messeges_telegram():
    ...
    if message_field:
        ...
        time.sleep(1)
        message_sender = Messages("This is test messages_telegram_web_a")
...
def check_database():
    try:
        ...
        if db.message_exists(messages, 'This is test messages_telegram_web_a'):
        ...
        if db.message_exists(files, 'Telegram_web_a.pdf'):
